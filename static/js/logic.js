 const url_quakes = 'https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson';
    ...
    var colordepth = [
        [10,'#00ff00','-10-10'],    // green 
        [25,'#99ff00','10-25'],     // light green
        [50,'#FFFF00','25-50'],     // yellow
        [74,'#ff9900','50-74'],     // orange
    ...
    function buildBasemaps()
    {
        // define maps
        basemaps = {
            '<span style=font-size:18px>Dark</span>': darkLayer,
            '<span style=font-size:18px>Watercolor</span>': watercolorLayer,            
